/**
 * Created by huangcheng on 2017/3/20.
 */
'use strict';
 ...
 *
 * @name pcmsApp.controller:ClueLbrHqEntity
 * @description
 * #ClueLbrHqEntity
...
angular.module('pcmsApp')
  .controller('ClueLbrHqCtrl',
    function($scope, PAGE_CONST, REGEX, Util, CommonModalSearch, codeMasterService, ClueLbrHqEntity, HybridUiGrid) {
      ...
      var init = function() {
        ...
        $scope.hybridObj.beApi = ClueLbrHqEntity.getAll;
      ...
      $scope.exportBtnEvent =function () {
        var url = '/ststcs/exportHQSalesChanceDealRpt';
