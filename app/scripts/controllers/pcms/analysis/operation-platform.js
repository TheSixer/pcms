 ...
 * @description
 * #OperationPlatformCtrl
 * Controller of the pcmsApp
 */
angular.module('pcmsApp')
  .controller('OperationPlatformCtrl',
    function($scope, PAGE_CONST, REGEX, Util, CommonModalSearch, codeMasterService, OperationPlatformEntity, HybridUiGrid) {
      ...
      var init = function() {
        ...
        $scope.hybridObj.beApi = OperationPlatformEntity.getAll;
      ...
      $scope.exportBtnEvent =function () {
        var url = '/ststcs/exportOprtPlatRptForHQ';
