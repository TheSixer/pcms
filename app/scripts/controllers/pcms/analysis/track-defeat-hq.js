 ...
 *
 * @name pcmsApp.controller:TrackDefeatHqCtrl
 * @description
 * #TrackDefeatHqCtrl
...
angular.module('pcmsApp')
  .controller('TrackDefeatHqCtrl',
    function($scope, PAGE_CONST, REGEX, Util, CommonModalSearch, codeMasterService, HybridUiGrid, TrackDefeatHqEntity, localStorageService) {
      ...
      var init = function() {
        ...
        $scope.hybridObj.beApi = TrackDefeatHqEntity.getAll;
      ...
      $scope.exportBtnEvent =function () {
        var url = '/ststcs/exportFollowFailRptForHQ';
