 ...
 * 潜客管理→系统管理→机会分配(4s)
 * @ngdoc function
 * @name pcmsApp.controller:AssignModalCtrl
 * @description
 * # AssignModalCtrl
...
angular.module('pcmsApp')
  .controller('AssignModalCtrl',
    function ($scope, Util, codeMasterService, $uibModalInstance, HybridUiGrid, saleChanceEntity, PAGE_CONST, loginData, TICKET, getSalesEntity) {
      // 初始化
      var init = function () {
